...
def runCB(scanRange, output, i, *args):
    ...
    cmd="combine -M MultiDimFit --setParameters=r_bin1=1,r_bin2=1,r_bin3=1,r_bin4=1,r_bin5=1,r_bin6=1,r_bin7=1,r_bin8=1,r_bin9=1,r_bin10=1   -t -1 -m 120 --algo=grid --points=100 -P r_bin%s --setParameterRanges r_bin%s=0.01,2 --X-rtd MINIMIZER_analytic   datacards/%s.root"%(str(i),str(i),datacard)
    os.system(cmd)
