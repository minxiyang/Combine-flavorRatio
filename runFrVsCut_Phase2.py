...
def main():
    ...
    for massCut in massCuts:
        ...
        for year in ["Phase2"]:
            for cg in ["bb","be"]:
                ...
                if year=="Phase2":tmps=tmpHandle("2018", cg, scale=scale)
        ...
        runCB(scanRange, "Phase2Combine", 0, *cardNames)
        fr=getFrAndLimits("Phase2Combine")
        print(fr)
        inv=0.2
        #while fr[0]==0. or fr[4]==0.:
        #    print("rerun combine")
    ...
    key="Phase2Combine"    
    plotFrVsCut(frsLeft2[key], frsLeft1[key], frsMed[key], frsRight1[key], frsRight2[key], massCuts, "Phase2Combine")    
